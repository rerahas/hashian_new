  ...
  (e.prototype = {
    ...
    _preload: function () {
      ...
      for (i = 0; i < this.settings.slides.length; i++)
        (this.settings.preload || this.settings.preloadImages) &&
          ...
          ((s = new Image()), (s.src = this.settings.slides[i].src)),
    ...
    _goto: function (s) {
      ...
      ("random" === y || y instanceof Array) &&
        (y = this._random(y instanceof Array ? y : this.transitions)),
        ("random" === w || w instanceof Array) &&
          (w = this._random(w instanceof Array ? w : this.animations)),
        ("auto" === _ || _ > g) && (_ = g),
        "auto" === b && (b = g),
        (e = t('<div class="vegas-slide"></div>')),
        this.support.transition && y && e.addClass("vegas-transition-" + y),
        this.support.video && d
          ? ((a = this._video(d instanceof Array ? d : d.src)),
            ...
            this.support.objectFit
              ? o
                  ...
                  .css("width", "100%")
                  .css("height", "100%")
              : "contain" === m && o.css("width", "100%").css("height", "100%"),
            e.append(o))
          : ((r = new Image()),
